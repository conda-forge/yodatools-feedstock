About yodatools-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yodatools-feedstock/blob/main/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `yodatools` can be installed with `conda`:
...
```
mamba install yodatools
```

It is possible to list all of the versions of `yodatools` available on your platform with `conda`:
...
```
mamba search yodatools --channel conda-forge
```
...
mamba repoquery search yodatools --channel conda-forge

# List packages depending on `yodatools`:
mamba repoquery whoneeds yodatools --channel conda-forge

# List dependencies of `yodatools`:
mamba repoquery depends yodatools --channel conda-forge
```
